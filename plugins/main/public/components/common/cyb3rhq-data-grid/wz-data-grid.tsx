...
import DiscoverDataGridAdditionalControls from '../cyb3rhq-discover/components/data-grid-additional-controls';
import './cyb3rhq-data-grid.scss';
import { wzDiscoverRenderColumns } from '../cyb3rhq-discover/render-columns';
import DocDetailsHeader from '../cyb3rhq-discover/components/doc-details-header';

export const MAX_ENTRIES_PER_QUERY = 10000;

export type tCyb3rhqDataGridProps = {
...
const Cyb3rhqDataGrid = (props: tCyb3rhqDataGridProps) => {
  const {
    results,
    defaultColumns,
    indexPattern,
  ...
  return (
    <>
      ...
      {!isLoading && results?.hits?.total > 0 ? (
        <div className='cyb3rhqDataGridContainer'>
          <EuiDataGrid
            {...dataGridProps}
...
export default Cyb3rhqDataGrid;
