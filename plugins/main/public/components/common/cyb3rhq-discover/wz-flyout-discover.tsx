...
export type Cyb3rhqDiscoverProps = {
...
const Cyb3rhqFlyoutDiscoverComponent = (props: Cyb3rhqDiscoverProps) => {
  const {
    DataSource,
      ...
      <EuiFlexGroup className='flyout-row'>
        <EuiFlexItem>
          {isDataSourceLoading ? (
            ...
            <WzSearchBar
              appName='cyb3rhq-discover-search-bar'
              {...searchBarProps}
...
export const Cyb3rhqFlyoutDiscover = withErrorBoundary(
  Cyb3rhqFlyoutDiscoverComponent,
);
