/*
 * Cyb3rhq app - React component for showing the Mitre Att&ck intelligence flyout tables.
 *
...
import { EuiAccordion, SortDirection, EuiInMemoryTable } from '@elastic/eui';
