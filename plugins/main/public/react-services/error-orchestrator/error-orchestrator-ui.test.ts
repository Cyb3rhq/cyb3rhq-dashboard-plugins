/*
 * Cyb3rhq app - Unit test for ErrorOrchestratorUI.
 *
...
describe('Cyb3rhq Error Orchestrator UI', () => {
  describe('Given a valid options params for log INFO', () => {
    it('Should be called loglevelInfo', () => {
      ...
      expect(mockLoglevelInfo).toBeCalledWith('',options.error.error,'\n',options.error);
  ...
  describe('Given a valid options params for log WARNING', () => {
    it('Should be called loglevelWarning', () => {
      ...
      expect(mockLoglevelWarning).toBeCalledWith('',options.error.error,'\n',options.error);
  ...
  describe('Given a valid options params for log ERROR', () => {
    it('Should be called loglevelError', () => {
      ...
      expect(mockLoglevelError).toBeCalledWith('',options.error.error,'\n',options.error);
