...
const linuxAgentMocked = {
  os: {
    ...
    platform: 'ubuntu',
    uname:
      'Linux |cyb3rhq_agent_ubuntu_sources_cmake-v4.3.4-rc1 |5.10.104-linuxkit |#1 SMP Thu Mar 17 17:08:06 UTC 2022 |x86_64',
    version: '18.04.6 LTS',
  },
  group: ['default'],
  status: 'active',
  ...
  registerIP: 'any',
  name: 'cyb3rhq_agent_ubuntu_sources_cmake-v4.3.4-rc1',
  version: 'Cyb3rhq v4.3.4',
  id: '001',
  ip: '172.18.0.5',
