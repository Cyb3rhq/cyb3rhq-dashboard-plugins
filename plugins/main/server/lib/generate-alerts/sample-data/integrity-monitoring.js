...
export const pathsLinux = [
  "/etc/resolv.conf",
  "/var/cyb3rhq/queue/fim/db/fim.db-journal",
  "/var/cyb3rhq/queue/fim/db/fim.db",
...
export const pathsWindows = [
  ...
  "c:\\program files (x86)\\cyb3rhq-agent\\wodles\\syscollector",
  "c:\\program files (x86)\\cyb3rhq-agent\\rids\\sender_counter",
  "c:\\program files (x86)\\cyb3rhq-agent\\queue\\fim\\db\\fim.db",
  "c:\\program files (x86)\\cyb3rhq-agent\\cyb3rhq-agent.state",
