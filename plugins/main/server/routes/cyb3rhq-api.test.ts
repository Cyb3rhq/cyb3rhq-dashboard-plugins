// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/cyb3rhq-api
...
describe.skip('Cyb3rhq API', () => {
  describe('Cyb3rhq API - /api/login', () => {
  ...
  describe('Cyb3rhq API - /api/check-api', () => {
      ...
      return axios(options).catch(error => {
        ...
        expect(
          error.response.data.message.includes(
            'Selected API is no longer available in cyb3rhq.yml',
          ),
        ).toBe(true);
      });
    });
  ...
  describe('Cyb3rhq API - /api/check-stored-api', () => {
    test('[200] Check default api returns manager, node, cluster, status and allow_run_as params', () => {
  ...
  describe('Cyb3rhq API - /api/request', () => {
    let userToken = null;
    beforeAll(() => {
  ...
  describe('Cyb3rhq API - /api/routes', () => {
  ...
  describe('Cyb3rhq API - /api/setup', () => {
  ...
  describe('Cyb3rhq API - /api/syscollector', () => {
