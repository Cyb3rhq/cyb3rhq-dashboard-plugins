/*
 * Cyb3rhq app - Module for Cyb3rhq reporting routes
 ...
 */
import { Cyb3rhqReportingCtrl } from '../controllers';
import { IRouter } from 'opensearch_dashboards/server';
import { schema } from '@osd/config-schema';

export function Cyb3rhqReportingRoutes(router: IRouter) {
  const ctrl = new Cyb3rhqReportingCtrl();
