// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/cyb3rhq-elastic
...
describe.skip('Cyb3rhq Elastic', () => {
  describe('Cyb3rhq API - /elastic/security/current-platform', () => {
  ...
  // describe('Cyb3rhq API - /elastic/visualizations/{tab}/{pattern}', () => {
  ...
  describe('Cyb3rhq API - /elastic/template/{pattern}', () => {
    test('[200] Check if there is some template with the pattern', () => {
      const options = buildAxiosOptions('get', '/elastic/template/cyb3rhq-alerts-*');
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
  ...
  // TODO: This test need to be defined
  // describe('Cyb3rhq API - /elastic/top/{mode}/{cluster}/{field}/{pattern}', () => {
  ...
  describe('Cyb3rhq API - /elastic/samplealerts', () => {
  ...
  describe('Cyb3rhq API - /elastic/samplealerts/{category}', () => {
  ...
  // TODO: This test need to be defined
  // describe('Cyb3rhq API - /elastic/alerts', () => {
  //   test('[200] Check if there an sample data index of Security category', () => {
  ...
  describe('Cyb3rhq API - /elastic/statistics', () => {
    test('[200] Check if there an sample data index of Security category', () => {
