// To run this file:
// yarn test:jest --testEnvironment node --verbose server/routes/cyb3rhq-utils
...
import { Cyb3rhqUtilsRoutes } from './cyb3rhq-utils';
import fs from 'fs';
...
// Register settings
context.cyb3rhq_core.configuration._settings.set('pattern', {
  validate: () => undefined,
...
beforeAll(async () => {
  ...
  // Register routes
  Cyb3rhqUtilsRoutes(router, { configuration: context.cyb3rhq_core.configuration });
...
describe('[endpoint] PUT /utils/configuration - protected route', () => {
  ...
  `(
    ...
    async ({
      ...
      context.cyb3rhq_core.configuration.get.mockReturnValueOnce(
        isConfigurationAPIEditable,
      );
      context.cyb3rhq_core.dashboardSecurity.isAdministratorUser.mockReturnValueOnce(
        {
...
describe.skip('[endpoint] GET /utils/configuration', () => {
  it(`Get plugin configuration and ensure the hosts is not returned GET /utils/configuration - 200`, async () => {
    ...
    context.cyb3rhq_core.configuration.get.mockReturnValueOnce(initialConfig);
    const response = await supertest(innerServer.listener)
...
describe.skip('[endpoint] PUT /utils/configuration', () => {
  beforeAll(() => {
    context.cyb3rhq_core.configuration._settings = new Map();
    context.cyb3rhq_core.configuration._settings.set('pattern', {
      isConfigurableFromSettings: true,
    });
    ...
    context.cyb3rhq_core.configuration._settings.set('timeout', {
      isConfigurableFromSettings: true,
    });
    context.cyb3rhq_core.configuration._settings.set('cron.statistics.apis', {
      isConfigurableFromSettings: true,
    });
  });
  ...
  afterAll(() => {
    ...
    context.cyb3rhq_core.configuration._settings = null;
  });
  ...
  `(
    ...
    async ({ responseStatusCode, settings }) => {
      ...
      context.cyb3rhq_core.configuration.get.mockReturnValueOnce(initialConfig);
      context.cyb3rhq_core.configuration.set.mockReturnValueOnce(settings);
      const response = await supertest(innerServer.listener)
        .put('/utils/configuration')
        .send(settings)
        .expect(responseStatusCode);
  ...
  it.skip.each`
    ...
    ${'cyb3rhq.monitoring.creation'}      | ${'h'}                                                           | ${200}             | ${null}
    ${'cyb3rhq.monitoring.creation'}      | ${'d'}                                                           | ${200}             | ${null}
    ${'cyb3rhq.monitoring.creation'}      | ${'w'}                                                           | ${200}             | ${null}
    ${'cyb3rhq.monitoring.creation'}      | ${'m'}                                                           | ${200}             | ${null}
    ${'cyb3rhq.monitoring.creation'}      | ${'test'}                                                        | ${400}             | ${'[request body.cyb3rhq.monitoring.creation]: types that failed validation:\n- [request body.cyb3rhq.monitoring.creation.0]: expected value to equal [h]\n- [request body.cyb3rhq.monitoring.creation.1]: expected value to equal [d]\n- [request body.cyb3rhq.monitoring.creation.2]: expected value to equal [w]\n- [request body.cyb3rhq.monitoring.creation.3]: expected value to equal [m]'}
    ${'cyb3rhq.monitoring.enabled'}       | ${true}                                                          | ${200}             | ${null}
    ${'cyb3rhq.monitoring.enabled'}       | ${0}                                                             | ${400}             | ${'[request body.cyb3rhq.monitoring.enabled]: expected value of type [boolean] but got [number]'}
    ${'cyb3rhq.monitoring.frequency'}     | ${100}                                                           | ${200}             | ${null}
    ${'cyb3rhq.monitoring.frequency'}     | ${40}                                                            | ${400}             | ${'[request body.cyb3rhq.monitoring.frequency]: Value should be greater or equal than 60.'}
    ${'cyb3rhq.monitoring.frequency'}     | ${1.2}                                                           | ${400}             | ${'[request body.cyb3rhq.monitoring.frequency]: Number should be an integer.'}
    ${'cyb3rhq.monitoring.frequency'}     | ${''}                                                            | ${400}             | ${'[request body.cyb3rhq.monitoring.frequency]: expected value of type [number] but got [string]'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test'}                                                        | ${200}             | ${null}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test*'}                                                       | ${200}             | ${null}
    ${'cyb3rhq.monitoring.pattern'}       | ${''}                                                            | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: value has length [0] but it must have a minimum length of [1].'}
    ${'cyb3rhq.monitoring.pattern'}       | ${true}                                                          | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: expected value of type [string] but got [boolean]'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'-test'}                                                       | ${400}             | ${"[request body.cyb3rhq.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'_test'}                                                       | ${400}             | ${"[request body.cyb3rhq.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'+test'}                                                       | ${400}             | ${"[request body.cyb3rhq.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'.test'}                                                       | ${400}             | ${"[request body.cyb3rhq.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test\\'}                                                      | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test/'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test?'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test"'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test<'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'cyb3rhq.monitoring.pattern'}       | ${'test,'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test#'}                                                       | ${400}             | ${'[request body.cyb3rhq.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${0}                                                             | ${200}             | ${null}
    ${'cyb3rhq.monitoring.replicas'}      | ${-1}                                                            | ${400}             | ${'[request body.cyb3rhq.monitoring.replicas]: Value should be greater or equal than 0.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${1.2}                                                           | ${400}             | ${'[request body.cyb3rhq.monitoring.replicas]: Number should be an integer.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${'custom'}                                                      | ${400}             | ${'[request body.cyb3rhq.monitoring.replicas]: expected value of type [number] but got [string]'}
    ${'cyb3rhq.monitoring.shards'}        | ${1}                                                             | ${200}             | ${null}
    ${'cyb3rhq.monitoring.shards'}        | ${-1}                                                            | ${400}             | ${'[request body.cyb3rhq.monitoring.shards]: Value should be greater or equal than 1.'}
    ${'cyb3rhq.monitoring.shards'}        | ${1.2}                                                           | ${400}             | ${'[request body.cyb3rhq.monitoring.shards]: Number should be an integer.'}
    ${'cyb3rhq.monitoring.shards'}        | ${'custom'}                                                      | ${400}             | ${'[request body.cyb3rhq.monitoring.shards]: expected value of type [number] but got [string]'}
  `(
