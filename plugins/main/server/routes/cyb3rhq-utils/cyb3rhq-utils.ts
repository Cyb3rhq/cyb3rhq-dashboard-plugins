/*
 * Cyb3rhq app - Module for Cyb3rhq utils routes
 ...
 */
import { Cyb3rhqUtilsCtrl } from '../../controllers';
...
export function Cyb3rhqUtilsRoutes(router: IRouter, services) {
  const ctrl = new Cyb3rhqUtilsCtrl();
