import md5 from 'md5';
import fs from 'fs';
import { Cyb3rhqReportingCtrl } from './cyb3rhq-reporting';
...
const endpointController = new Cyb3rhqReportingCtrl();
...
describe('[security] Report endpoints guard related to a file. Parameter defines or builds the filename.', () => {
  ...
  it.each`
    ...
    ${'Execute endpoint handler'} | ${'admin'}     | ${'cyb3rhq-module-overview-general-1234.pdf'}          | ${false}
    ${'Endpoint protected'}       | ${'admin'}     | ${'../cyb3rhq-module-overview-general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'cyb3rhq-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'custom../cyb3rhq-module-overview-general-1234.pdf'} | ${true}
    ${'Execute endpoint handler'} | ${'../../etc'} | ${'cyb3rhq-module-agents-001-general-1234.pdf'}        | ${false}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'../cyb3rhq-module-agents-001-general-1234.pdf'}     | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'cyb3rhq-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'custom../cyb3rhq-module-overview-general-1234.pdf'} | ${true}
  `(
    `$testTitle
	username: $username
	filename: $filename
...
describe('[security] GET /reports/{name}', () => {
  it.each`
    ...
    ${'Get report'}         | ${'admin'}     | ${'cyb3rhq-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../cyb3rhq-module-overview-1234.pdf'} | ${false}
    ${'Get report'}         | ${'../../etc'} | ${'cyb3rhq-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../cyb3rhq-module-overview-1234.pdf'} | ${false}
  `(
    ...
    async ({ username, moduleID, valid }) => {
      ...
      if (valid) {
        ...
        expect(response.body.message).toMatch(
          new RegExp(`Report cyb3rhq-module-overview-${moduleID}`),
        );
      } else {
        expect(response.body.message).toBe('5040 - You shall not pass!');
      }
...
describe('[security] DELETE /reports/<filename>', () => {
  ...
  it.each`
    titleTest               | username       | filename                                     | valid
    ${'Delete report'}      | ${'admin'}     | ${'cyb3rhq-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../cyb3rhq-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'admin'}     | ${'custom../cyb3rhq-module-overview-1234.pdf'} | ${false}
    ${'Delete report'}      | ${'../../etc'} | ${'cyb3rhq-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../cyb3rhq-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'../../etc'} | ${'custom../cyb3rhq-module-overview-1234.pdf'} | ${false}
  `(
