...
if [ ! -f $WITNESS_FILE_PATH ]; then
    ...
    sed -i "s:<name>cyb3rhq</name>:<name>$CLUSTER_NAME</name>:g" /var/ossec/etc/ossec.conf
...
/var/ossec/bin/cyb3rhq-apid restart
