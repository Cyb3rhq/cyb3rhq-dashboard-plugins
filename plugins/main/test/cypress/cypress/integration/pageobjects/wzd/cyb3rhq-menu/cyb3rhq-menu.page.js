export const CYB3RHQ_MENU_PAGE = {
  cyb3rhqMenuLeft: '.wz-menu-left-side .wz-menu-sections',
  cyb3rhqMenuRight: '.wz-menu-right-side',
  cyb3rhqMenuSettingRight: '.wz-menu-right-side .WzManagementSideMenu',
  cyb3rhqMenuButton: '[data-test-subj=menuCyb3rhqButton]',
  //region Menu
  //region Menu
