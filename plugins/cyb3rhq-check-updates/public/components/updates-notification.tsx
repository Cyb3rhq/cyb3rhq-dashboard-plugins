...
import { getCore, getCyb3rhqCore } from '../plugin-services';
import { AvailableUpdates } from '../../../cyb3rhq-check-updates/common/types';
...
export const UpdatesNotification = () => {
  ...
  const sideNavDocked = getCyb3rhqCore().hooks.useDockedSideNav();
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <EuiText>
                  <FormattedMessage
                    id='cyb3rhqCheckUpdates.updatesNotification.message'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <RedirectAppLinks application={getCore().application}>
                  ...
                  >
                    <FormattedMessage
                      id='cyb3rhqCheckUpdates.updatesNotification.linkText'
            ...
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false}>
                <EuiCheckbox
                  ...
                  label={
                    <FormattedMessage
                      id='cyb3rhqCheckUpdates.updatesNotification.dismissCheckText'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                ...
                >
                  <FormattedMessage
                    id='cyb3rhqCheckUpdates.updatesNotification.closeButtonText'
