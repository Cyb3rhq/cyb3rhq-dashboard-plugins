...
export const CYB3RHQ_DATA_CONFIG_APP_PATH = path.join(
  CYB3RHQ_DATA_CONFIG_DIRECTORY_PATH,
  'cyb3rhq.yml',
);
...
export const REPORTS_PAGE_FOOTER_TEXT = 'Copyright © 2023 Cyb3rhq, Inc.';
...
export const PLUGIN_SETTINGS_CATEGORIES: {
  ...
  [SettingCategory.CUSTOMIZATION]: {
    ...
    documentationLink: 'user-manual/cyb3rhq-dashboard/white-labeling.html',
...
export const PLUGIN_SETTINGS: { [key: string]: TPluginSetting } = {
  'alerts.sample.prefix': {
    ...
    defaultValue: CYB3RHQ_SAMPLE_ALERT_PREFIX,
  ...
  'cron.prefix': {
    ...
    category: SettingCategory.GENERAL,
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_PREFIX,
    isConfigurableFromSettings: true,
    validateUIForm: function (value) {
      return this.validate(value);
    },
  ...
  'cron.statistics.index.creation': {
    ...
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_CREATION,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cron.statistics.index.name': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_NAME,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cron.statistics.index.replicas': {
    ...
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_INDICES_REPLICAS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'cron.statistics.index.shards': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.number,
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_INDICES_SHARDS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'cron.statistics.interval': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_CRON_FREQ,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
  ...
  'cron.statistics.status': {
    ...
    category: SettingCategory.STATISTICS,
    type: EpluginSettingType.switch,
    defaultValue: CYB3RHQ_STATISTICS_DEFAULT_STATUS,
    isConfigurableFromSettings: true,
    options: {
      switch: {
        values: {
  ...
  'customization.logo.app': {
    title: 'App main logo',
    description: `This logo is used as loading indicator while the user is logging into Cyb3rhq API.`,
    store: {
      file: {
        configurableManaged: true,
      },
...
#       # Use RBAC or not. If set to true, the username must be "cyb3rhq-wui".
#       run_as: true
#   - env-2:
...
hosts:
  ...
  pattern: {
    ...
    category: SettingCategory.GENERAL,
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_ALERTS_PATTERN,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    // Validation: https://github.com/elastic/elasticsearch/blob/v7.10.2/docs/reference/indices/create-index.asciidoc
    validateUIForm: function (value) {
  ...
  'cyb3rhq.monitoring.creation': {
    title: 'Index creation',
    description:
      'Define the interval in which a new cyb3rhq-monitoring index will be created.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    defaultValue: CYB3RHQ_MONITORING_DEFAULT_CREATION,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cyb3rhq.monitoring.enabled': {
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.switch,
    defaultValue: CYB3RHQ_MONITORING_DEFAULT_ENABLED,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
    options: {
      switch: {
  ...
  'cyb3rhq.monitoring.frequency': {
    title: 'Frequency',
    description:
      'Frequency, in seconds, of API requests to get the state of the agents and create a new document in the cyb3rhq-monitoring index with this data.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: CYB3RHQ_MONITORING_DEFAULT_FREQUENCY,
    isConfigurableFromSettings: true,
    requiresRestartingPluginPlatform: true,
    options: {
      number: {
  ...
  'cyb3rhq.monitoring.pattern': {
    title: 'Index pattern',
    description: 'Default index pattern to use for Cyb3rhq monitoring.',
    store: {
      file: {
        configurableManaged: true,
      },
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_MONITORING_PATTERN,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    validateUIForm: function (value) {
      return this.validate(value);
  ...
  'cyb3rhq.monitoring.replicas': {
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: CYB3RHQ_MONITORING_DEFAULT_INDICES_REPLICAS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'cyb3rhq.monitoring.shards': {
    ...
    category: SettingCategory.MONITORING,
    type: EpluginSettingType.number,
    defaultValue: CYB3RHQ_MONITORING_DEFAULT_INDICES_SHARDS,
    isConfigurableFromSettings: true,
    requiresRunningHealthCheck: true,
    options: {
      number: {
  ...
  'vulnerabilities.pattern': {
    ...
    type: EpluginSettingType.text,
    defaultValue: CYB3RHQ_VULNERABILITIES_PATTERN,
    isConfigurableFromSettings: true,
...
// Plugin settings
export const CYB3RHQ_CORE_ENCRYPTION_PASSWORD = 'secretencryptionkey!';

// Configuration backend service
export const CYB3RHQ_CORE_CONFIGURATION_INSTANCE = 'cyb3rhq-dashboard';
export const CYB3RHQ_CORE_CONFIGURATION_CACHE_SECONDS = 10;

// API connection permissions
export const CYB3RHQ_ROLE_ADMINISTRATOR_ID = 1;
