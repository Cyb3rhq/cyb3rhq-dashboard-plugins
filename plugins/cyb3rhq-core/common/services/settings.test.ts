...
describe('[settings] Methods', () => {
  ...
  //     ${true}              | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Cyb3rhq, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${'Custom footer'}        | ${'Copyright © 2023 Cyb3rhq, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Cyb3rhq, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Cyb3rhq, Inc.'}
