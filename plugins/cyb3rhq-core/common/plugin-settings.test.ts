...
describe('[settings] Input validation', () => {
  it.each`
    ...
    ${'timeout'}                        | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.creation'}      | ${'h'}                                                                 | ${undefined}
    ${'cyb3rhq.monitoring.creation'}      | ${'d'}                                                                 | ${undefined}
    ${'cyb3rhq.monitoring.creation'}      | ${'w'}                                                                 | ${undefined}
    ${'cyb3rhq.monitoring.creation'}      | ${'m'}                                                                 | ${undefined}
    ${'cyb3rhq.monitoring.creation'}      | ${'test'}                                                              | ${'Invalid value. Allowed values: h, d, w, m.'}
    ${'cyb3rhq.monitoring.enabled'}       | ${true}                                                                | ${undefined}
    ${'cyb3rhq.monitoring.frequency'}     | ${100}                                                                 | ${undefined}
    ${'cyb3rhq.monitoring.frequency'}     | ${40}                                                                  | ${'Value should be greater or equal than 60.'}
    ${'cyb3rhq.monitoring.frequency'}     | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.frequency'}     | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test'}                                                              | ${undefined}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test*'}                                                             | ${undefined}
    ${'cyb3rhq.monitoring.pattern'}       | ${''}                                                                  | ${'Value can not be empty.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'-test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'_test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'+test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'.test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test\\'}                                                            | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test/'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test?'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test"'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test<'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'cyb3rhq.monitoring.pattern'}       | ${'test,'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.pattern'}       | ${'test#'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${0}                                                                   | ${undefined}
    ${'cyb3rhq.monitoring.replicas'}      | ${-1}                                                                  | ${'Value should be greater or equal than 0.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.replicas'}      | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.shards'}        | ${1}                                                                   | ${undefined}
    ${'cyb3rhq.monitoring.shards'}        | ${-1}                                                                  | ${'Value should be greater or equal than 1.'}
    ${'cyb3rhq.monitoring.shards'}        | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'cyb3rhq.monitoring.shards'}        | ${1.2}                                                                 | ${'Number should be an integer.'}
