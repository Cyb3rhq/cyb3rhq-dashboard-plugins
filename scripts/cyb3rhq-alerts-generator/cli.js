(function () {
  ...
  const cliName = 'Cyb3rhq alerts generator';
  const cliDescription = 'Generates sample data of Cyb3rhq alerts';
  ...
  const defaultConfiguration = {
    ...
    alertGenerationParams: {
      ...
      cluster: {
        name: 'cyb3rhq-cluster',
        node: 'cyb3rhq-manager',
      },
    },
  };
...
- Generate alerts for all the modules in OpenSearch/Elasticsearch Bulk API format to a cyb3rhq-alerts index and save to a output.ndjson file
node ${cliFilePath} --all-modules --format bulk-api --index cyb3rhq-alerts > output.ndjson
