/*
 * Cyb3rhq app - Docker sample data
...
module.exports.actorAttributesImage = ["cyb3rhq/cyb3rhq:3.12.0-7.6.1", "docker.elastic.co/elasticsearch/elasticsearch:7.6.2", "docker.elastic.co/kibana/kibana:7.6.2", "nginx:latest"];
module.exports.type = ["container", "image", "volume", "network"];
module.exports.action = ["start", "stop", "pause", "unpause"];
module.exports.actorAttributesName = ["wonderful_page", "nostalgic_gates", "jovial_zuckerberg", "inspiring_jobs", "opening_torvalds", "gifted_bezos", "clever_wales", "laughing_tesla", "kind_nobel"]; // https://github.com/moby/moby/blob/5aa44cdf132788cc0cd28ce2393b44265dd400e9/pkg/namesgenerator/names-generator.go#L600
...
module.exports.dataDocker = [{
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository cyb3rhq/cyb3rhq pulled",
      id: "87932",
      firedtimes: 1,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "cyb3rhq/cyb3rhq:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "cyb3rhq/cyb3rhq:3.9.2_7.1.1",
          Attributes: {
            name: "cyb3rhq/cyb3rhq"
          }
        },
        scope: "local",
        time: "1563354346",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository cyb3rhq/cyb3rhq-elasticsearch pulled",
      id: "87932",
      firedtimes: 2,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "cyb3rhq/cyb3rhq-elasticsearch:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "cyb3rhq/cyb3rhq-elasticsearch:3.9.2_7.1.1",
          Attributes: {
            ...
            name: "cyb3rhq/cyb3rhq-elasticsearch",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository cyb3rhq/cyb3rhq-kibana pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "cyb3rhq/cyb3rhq-kibana:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "cyb3rhq/cyb3rhq-kibana:3.9.2_7.1.1",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository cyb3rhq/cyb3rhq-nginx pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "cyb3rhq/cyb3rhq-nginx:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "cyb3rhq/cyb3rhq-nginx:3.9.2_7.1.1",
