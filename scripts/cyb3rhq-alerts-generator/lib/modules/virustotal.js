/*
 * Cyb3rhq app - Virustotal sample data
...
// Virustotal
module.exports.sourceFile = ['/usr/share/sample/program', "/etc/data/file", "/etc/sample/script", "/root/super-script", "/tmp/virus/notavirus", "/var/opt/amazing-file"];
