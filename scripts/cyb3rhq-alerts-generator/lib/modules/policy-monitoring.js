/*
 * Cyb3rhq app - Policy monitoring sample alerts
...
module.exports.ruleDescription = ["Host-based anomaly detection event (rootcheck).", "System Audit event."];
