...
title: 'Release [CYB3RHQ VERSION] - Release Candidate [RC VERSION] - Cyb3rhq UI regression testing'
...
| Status         | Platform                       |
|----------------|--------------------------------|
| :black_circle: | Cyb3rhq dashboards [VERSION][RC] |
